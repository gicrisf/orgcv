...
#+RESULTS: web-skills-json
: {"name": "Web Development", "level": "High", "keywords": ["HTML5", "CSS", "JS/Typescript", "Liquid", "Jinja2", "Tera", "Twig", "Zola", "Pelican", "Jamstack"]}
...
: {"name": "Pharma", "level": "High", "keywords": ["Pharmaceutical Analysis", "Spectroscopy", "Data viz."]}
...
: {"name": "Programming", "level": "High", "keywords": ["Rust", "Python", "Lisp", "Vala", "C", "Git", "Php"]}

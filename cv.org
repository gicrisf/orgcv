...
\cvevent{ {%- if project.name -%}{{project.name}}{%- endif -%} }
  { {%- if project.description -%}{{project.description}}{%- endif -%} }
  { {%- if project.when -%}{{project.when}}{%- endif -%} } {}
...
\par\divider
\cvevent{Gotosi}
  {Isotope oriented periodic table of elements}
  {Feb. 2021 - Maggio 2021} {}
...
\par\divider
\cvevent{3D renders}
  {Bio/Chem molecular renders for fun and blogging}
  {} {}

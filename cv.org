...
Intendiamo ottenere questo dizionario:
#+name: personalinfo-context
#+begin_src python :session cv-venv
context = {
...
Ancora meglio! Potrei generarlo a partire da una tabella!
...
La tabella mi produce una lista di righe. Per ogni riga troviamo una lista degli elementi nella colonna indicata.
Possiamo convertirla in dizionario successivamente.

...
# (with vim substite command, use this regex: =:%s/\s\<latex\C//\>/tex/g=
...
#+begin_src bash :noweb no-export :results silent
...
#+begin_src python :noweb no-export :results output silent
